...
const WS = '/tmp/opencode/r30-ws'
const DATA = '/tmp/opencode/r30-data'
const SOCK = '/tmp/opencode/r30-code-index.sock'
...
const trace = await import(join(MALONG_DIR, 'tools', 'tool-trace-symbol', 'handler.js'))
...
const et = await import(join(MALONG_DIR, 'tools', 'tool-edit-transaction', 'handler.js'))
...
const df = await import(join(MALONG_DIR, 'tools', 'tool-diff-facts', 'handler.js'))
